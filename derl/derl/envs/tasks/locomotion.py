...
try:
    ...
    from derl.derl.envs.modules.agent import Agent
    from derl.derl.envs.modules.floor import Floor
    from derl.derl.envs.modules.terrain import Terrain
...
try:
    ...
    import sys
    sys.path.append("..")
    from derl.derl.envs.wrappers.hfield import AvoidWallReward
    from derl.derl.envs.wrappers.hfield import HfieldObs1D
    from derl.derl.envs.wrappers.hfield import HfieldObs2D
    from derl.derl.envs.wrappers.hfield import StandReward
    from derl.derl.envs.wrappers.hfield import TerminateOnFalling
    from derl.derl.envs.wrappers.hfield import TerminateOnRotation
    from derl.derl.envs.wrappers.hfield import TerminateOnTerrainEdge
    from derl.derl.envs.wrappers.hfield import TerminateOnWallContact
    from derl.derl.envs.wrappers.hfield import UnimalHeightObs
